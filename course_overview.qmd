# Introduction {#sec-course-introduction}
...
The Open edX platform is currently only running locally and we are working on deploying it asap.
Please be patient.
:::
